 ...
 * @module config/rutinas
 */

/**
 * Diccionario de rutinas predefinidas para entrenamiento.
 * Cada clave corresponde al value del <select> en el HTML.
 * Los valores contienen: repeticiones, bajada, fondo, subida, cima.
 * Nota: Las subidas explosivas ('X') se traducen a 1 segundo.
 */
